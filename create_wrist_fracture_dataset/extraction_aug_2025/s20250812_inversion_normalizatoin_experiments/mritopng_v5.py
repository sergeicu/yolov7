...
def convert_file(mri_file_path, png_file_path, overwrite=False):
...
def convert_folder(mri_folder, png_folder, overwrite=False):
        ...
        for mri_file in os.listdir(mri_sub_folder):
            ...
            if os.path.isfile(mri_file_path):
                ...
                try:
                    ...
                    convert_file(mri_file_path, png_file_path, overwrite=overwrite)
...
if __name__ == '__main__':
    ...
    print(args)
    if args.f:
        convert_folder(args.dicom_path, args.png_path, args.overwrite)
    else:
        convert_file(args.dicom_path, args.png_path, args.overwrite) 