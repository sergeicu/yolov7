...
if __name__ == "__main__":
    ...
    parser.add_argument("--source_dir", default = '/home/ch215616/w/code/llm/experiments/yolov7/wrist_fracture_dataset/dcm/',help="Directory containing subdirectories with PNG files.")
    parser.add_argument("--dest_dir", default = '/home/ch215616/w/code/llm/experiments/yolov7/wrist_fracture_dataset/pngs/', help="Directory to copy all PNG files to.")
